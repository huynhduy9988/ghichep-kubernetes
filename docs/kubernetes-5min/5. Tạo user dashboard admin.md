...
![Sing in](https://raw.githubusercontent.com/kubernetes/dashboard/master/docs/images/signin.png)

Click `Sign in` button and that's it. You are now logged in as an admin.

![Overview](https://raw.githubusercontent.com/kubernetes/dashboard/master/docs/images/overview.png)
